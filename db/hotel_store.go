...
func NewMongoHotelStore(cl *mongo.Client) *MongoHotelStore {
	return &MongoHotelStore{
		client: cl,
		coll:   cl.Database(DBNAME).Collection("hotels"),
	}
}

func (s *MongoHotelStore) GetHotels(ctx context.Context, filter bson.M) ([]*types.Hotel, error) {

	fmt.Println("Inside hotelstore.GetHotel")
...
func (s *MongoHotelStore) Update(ctx context.Context, f bson.M, u bson.M) error {
	_, err := s.coll.UpdateOne(ctx, f, u)
	return err
}
